...
<div class="content update">
    ...
    <form action="update.php?id_no=<?=$student['id_no']?>" method="post">
        ...
        <input type="text" name="id" placeholder="0123" value="<?=$student['id']?>" id="id">
        <input type="text" name="name" placeholder="Janice" value="<?=$student['name']?>" id="name">
        <label for="email">Email</label>
        <label for="phone">Phone</label>
        <input type="text" name="email" placeholder="jandash01@gmail.com" value="<?=$student['email']?>" id="email">
        <input type="text" name="phone" placeholder="09304026307" value="<?=$student['phone']?>" id="phone">
        <label for="title">Title</label>
        <label for="created">Created</label>
        <input type="text" name="title" placeholder="Student" value="<?=$student['title']?>" id="title">
