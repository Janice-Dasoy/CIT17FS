...
<div class="content update">
	...
	<table>
		...
		<input type="text" name="id_no" placeholder="0123" value="auto" id="id_no">
        <input type="text" name="F_name" placeholder="Janice" id="F_name">
		
		<label for="M_name">Middle Name</label>
		<label for="L_name">Last Name</label>
		<input type="text" name="M_name" placeholder="Licupa" id="M_name">
		<input type="text" name="L_name" placeholder="Dasoy" id="L_name">
		
		<label for="email">Email</label>
		<label for="phone">Phone</label>	
		<input type="text" name="email" placeholder="jandash01@gmail.com" id="email">
        <input type="text" name="phone" placeholder="09304026307" id="phone">
